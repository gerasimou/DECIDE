...
const double rt1l1i = 10 ;
const double rt1l2i = 10 ;
const double rt1l2ip = 5;
const double rt1p2norm = 0.8 ;
const double rt1p2retry = 0.5;
const double rt1c1i = 8 ;
const double rt1c2i = 5;

const double rt2l1i = 10 ;
const double rt2l2i  = 10;
const double rt2l3i = 5 ;
const double rt2l3ip = 8;
const double rt2p2req = 0.7 ;
const double rt2p2retry = 0.5 ;
const double rt2p3poss = 1 ;
const double rt2c1i = 8 ;
const double rt2c2i = 5 ;
const double rt2c3i = 13 ;
