...
SENSOR1_1_TICK="5" SENSOR1_2_TICK="4" SENSOR1_3_TICK="4.5"
SENSOR1_1_FAIL="" SENSOR1_2_FAIL="" SENSOR1_3_FAIL="50:150,200:300,350:450"
#Vehicle 2
VEHICLE_NAME_2="HERMES"
START_POSITION_2="-20,-25"
LOITER_X_2="150" LOITER_Y_2="-115"
SENSOR2_1_TICK="3.5" SENSOR2_2_TICK="4.5" SENSOR2_3_TICK="4"
SENSOR2_1_FAIL="" SENSOR2_2_FAIL="1050:1150,1300:1400,1750:1850" SENSOR2_3_FAIL=""
#Vehicle 3
VEHICLE_NAME_3="ZEUS"
START_POSITION_3="-0,5"
LOITER_X_3="75" LOITER_Y_3="-25"
SENSOR3_1_TICK="5" SENSOR3_2_TICK="4.5" SENSOR3_3_TICK="5"
SENSOR3_1_FAIL="" SENSOR3_2_FAIL="" SENSOR3_3_FAIL="3050:3150,3300:3400,3900:4000"
#Vehicle 4
...
do
	...
	nsplug meta_vehicle.moos targ_${!VEHICLE_NAME}.moos -f WARP=$TIME_WARP  								\
		...
		SENSOR1_FAIL_PATTERN=${!SENSOR1_FAIL_PATTERN} 	SENSOR1_DEGRADATION_VALUE_PATTERN="0.9"				\
		SENSOR2_FAIL_PATTERN=${!SENSOR2_FAIL_PATTERN}	SENSOR2_DEGRADATION_VALUE_PATTERN="0.55,0.65, 0.2"	\
		SENSOR3_FAIL_PATTERN=${!SENSOR3_FAIL_PATTERN}	SENSOR3_DEGRADATION_VALUE_PATTERN="0.55,0.65, 0.2"	\
