...
#DECIDE_JAR=DECIDEfat
	...
	mkdir -p ${COMP_DIR}/resources/uuv
	cp -r ${TARGET_DIR}/resources/uuv/config${ROBOT_ID}.properties	${COMP_DIR}/resources/uuv/
	mv ${COMP_DIR}/resources/uuv/config${ROBOT_ID}.properties			${COMP_DIR}/resources/uuv/config.properties	
	...
	cp -r ${TARGET_DIR}/models/uuv 								${COMP_DIR}/models/
	cp -r repo 													${COMP_DIR}/
