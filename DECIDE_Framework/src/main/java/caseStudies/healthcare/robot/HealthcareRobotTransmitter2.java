...
public class HealthcareRobotTransmitter2 extends SocketTransmitter implements Runnable{

	Random rand = new Random();

	public HealthcareRobotTransmitter2(String serverAddress, int port, ComponentTypeDECIDE networkType) {
