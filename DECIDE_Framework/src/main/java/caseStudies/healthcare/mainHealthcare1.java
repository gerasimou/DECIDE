...
public class mainHealthcare1 {

	static Logger logger = LogManager.getLogger(mainHealthcare1.class);
	...
	public static void main(String[] args) throws DecideException {	
		...
		String configurationFile = "resources" + File.separator + "healthcare" +File.separator +"config1.properties";
...
//		SelectionNew selection 		= new RobotSelectionExhaustive();
		...
		RobotKnowledge.setMyAddress(lca.getTransmitterToOtherDECIDE().getServerAddress());
