...
public class ServerSocketDECIDE implements Runnable, Serializable{
	
	/** Class logger*/
	private final static Logger logger = Logger.getLogger(ServerSocketDECIDE.class);
	 ...
	 * @param port number
	 */
	public ServerSocketDECIDE(int port){
		try {
